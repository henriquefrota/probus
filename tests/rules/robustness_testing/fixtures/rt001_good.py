"""Equity factor model on time-ordered data — correct temporal split.

shuffle=False preserves the chronological order of observations. The model
trains on earlier dates and is evaluated on later dates, reflecting the
information constraint of a live trading system.
"""
...
X_train, X_test, y_train, y_test = train_test_split(
    X, y.values, test_size=0.3, shuffle=False
)
